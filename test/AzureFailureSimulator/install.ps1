<#
	.SYNOPSIS
		Installs the AzureFailureSimulator Module from github
		
	.DESCRIPTION
		This script installs the AzureFailureSimulator Module from github.
