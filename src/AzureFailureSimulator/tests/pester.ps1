...
Remove-Module AzureFailureSimulator -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\AzureFailureSimulator.psd1"
Import-Module "$PSScriptRoot\..\AzureFailureSimulator.psm1" -Force
